...
const loadGridMyShips = function () {
    var options = {
        width: 10,
        height: 10,
        verticalMargin: 0,
    ...
    createGrid(11, $(".grid-myShips"), 'myShips')
}
const createMyGrid = function (size, element, id) {
    // definimos un nuevo elemento: <div></div>
    let wrapper = document.createElement('DIV')
...
const loadGridEnemyShips = function () {
    var options = {
        width: 10,
        height: 10,
        verticalMargin: 0,
    ...
    createGrid(11, $(".grid-enemyShips"), 'enemyShips')
}
const createEnemyGrid = function (size, element, id) {
    // definimos un nuevo elemento: <div></div>
    let wrapper = document.createElement('DIV')
...
const rotateShips = function (shipType, cells) {
    ...
    $(`#${shipType}`).click(function () {
        document.getElementById("alert-text").innerHTML = `Rotated: ${shipType}`
        console.log($(this))
